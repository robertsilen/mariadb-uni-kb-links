...
def search_text_kb(input_text="Installing MariaDB with package manager", n=3):
    closest_content = search_for_closest_content(input_text, n)
    input_text = "Suggest further reading links for this MariaDB blog post title: " + input_text
    print(input_text)
...
# to search for one individual text in the KB
search_text_kb(read_txt_file("02_test_input.txt"), n=10)

# to itertate through MariaDB Uni files
iterate_uni_files()
